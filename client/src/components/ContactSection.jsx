  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at indaco.mat@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/indaco-mat",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/indaco.mat",
                  },
