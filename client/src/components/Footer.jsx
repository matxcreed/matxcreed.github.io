...
export const Footer = () => {
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "indaco.mat@gmail.com", href: "mailto:indaco.mat@gmail.com.com" },
    { icon: <Phone size={16} />, text: "+54 1144245111", href: "tel:+541144245111" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Matias Indaco</h3>
          ...
          >
            <div>
              <p>© {currentYear} Matias Indaco. All rights reserved.</p>
            </div>
